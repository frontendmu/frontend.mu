...
<template>
  <section
    class="hero-section relative min-h-[min(calc(100vh-5rem),900px)] flex items-center overflow-hidden pt-24 pb-12 lg:pt-24 lg:pb-8"
  >
      ...
      <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        ...
        <div class="hero-content w-full lg:w-[55%] text-center lg:text-left space-y-5">
          <div class="flex flex-col">
            <span
              class="text-xs md:text-sm font-semibold uppercase tracking-[0.3em] text-verse-500/80 block leading-none mb-4 lg:mb-5"
            >
              Est. 2016
            </span>

            <h1
              class="hero-heading font-display relative z-10 tracking-tight leading-[0.85] dark:text-white pointer-events-auto cursor-default"
            >
              <span class="block">{{ displayText }}<span class="typing-cursor">|</span></span>
              <span class="block">Coders</span>
              <span
                class="relative inline-block font-display-italic text-verse-600 dark:text-verse-400"
              >
                Mauritius
              </span>
            </h1>
          ...
          <p
            class="text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium"
          >
            {{ description }}
          </p>
          ...
          <div class="flex flex-wrap items-center justify-center lg:justify-start gap-3">
            ...
            >
              <div
                class="flex items-center justify-center w-7 h-7 rounded-full bg-white/20 text-[10px] font-black leading-none"
              >
              ...
              <svg
                class="w-4 h-4 opacity-60 transition-transform group-hover:translate-x-0.5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              ...
              <svg
                class="w-4 h-4 ml-2 opacity-40 group-hover:opacity-100 transition-all group-hover:translate-x-0.5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div class="flex items-center gap-1">
              <a
                :href="GITHUB_URL"
                target="_blank"
                aria-label="Frontend Coders Mauritius on GitHub"
                class="p-2.5 text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors"
              >
              ...
              <a
                :href="DISCORD_URL"
                target="_blank"
                aria-label="Frontend Coders Mauritius on Discord"
                class="p-2.5 text-gray-400 dark:text-gray-500 hover:text-[#5865F2] transition-colors"
              >
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path
              ...
              <a
                :href="TWITTER_URL"
                target="_blank"
                aria-label="Frontend Coders Mauritius on X (Twitter)"
                class="p-2.5 text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors"
              >
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path
              ...
              <a
                :href="LINKEDIN_URL"
                target="_blank"
                aria-label="Frontend Coders Mauritius on LinkedIn"
                class="p-2.5 text-gray-400 dark:text-gray-500 hover:text-[#0A66C2] transition-colors"
              >
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path
        ...
        >
          <div class="relative w-72 h-72 lg:w-96 lg:h-96">
            <div
              ref="ring1"
              class="absolute inset-0 rounded-full border-2 border-dashed border-verse-500/20"
            ></div>
            <div ref="ring2" class="absolute inset-6 rounded-full border border-verse-500/10"></div>
            <div
              class="absolute inset-12 rounded-[3.5rem] squircle bg-white dark:bg-verse-900/40 backdrop-blur-2xl border border-verse-200 dark:border-verse-700 flex items-center justify-center shadow-2xl p-12 rotate-3 transition-transform hover:rotate-0 duration-500 group/logo"
            >
              <Logo
                class="w-full h-full text-verse-500 dark:text-white transition-transform duration-500 group-hover/logo:scale-110"
              />
            </div>
            <div ref="shapesContainer" class="absolute inset-0">
              <div
                class="absolute -top-4 -right-4 w-12 h-12 bg-[#EA2839] rounded-2xl animate-float opacity-80 shadow-lg transition-transform duration-300 hover:scale-125"
                @mouseenter="isShapeHovered = true"
                @mouseleave="isShapeHovered = false"
              ></div>
              <div
                class="absolute top-8 -left-6 w-8 h-8 bg-[#1A206D] rounded-full animate-float-slow opacity-80 shadow-lg transition-transform duration-300 hover:scale-125"
                style="animation-delay: 0.5s"
                @mouseenter="isShapeHovered = true"
                @mouseleave="isShapeHovered = false"
              ></div>
              <div
                class="absolute bottom-10 -left-2 w-10 h-10 bg-[#FFD600] rounded-xl animate-float opacity-80 shadow-lg transition-transform duration-300 hover:scale-125"
                style="animation-delay: 1.5s"
                @mouseenter="isShapeHovered = true"
                @mouseleave="isShapeHovered = false"
              ></div>
              <div
                class="absolute -bottom-2 right-12 w-9 h-9 bg-[#00A551] rounded-lg animate-float-slow opacity-80 shadow-lg transition-transform duration-300 hover:scale-125"
