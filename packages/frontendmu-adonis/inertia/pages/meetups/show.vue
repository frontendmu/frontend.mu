      ...
      <div class="py-6 lg:py-10">
            ...
            <div class="lg:col-span-2">
              ...
              >
                <div class="flex items-center justify-between mb-4">
                  <div>
                    <p v-if="hasRsvp && rsvpStatus === 'confirmed'" class="text-sm font-medium text-emerald-600 dark:text-emerald-400">
                      You're going
                    </p>
                    <p v-else-if="hasRsvp && rsvpStatus === 'waitlist'" class="text-sm font-medium text-amber-600 dark:text-amber-400">
                      On waitlist
                    </p>
                  ...
                  <template v-if="!isAuthenticated && canRsvp">
                    <Link href="/login" class="px-5 py-2.5 text-sm font-semibold text-white bg-gray-900 dark:bg-gray-100 dark:text-gray-900 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors">
                      Login to RSVP
                    </Link>
                  </template>
                ...
                <!-- Capacity bar -->
                <div v-if="meetup.seatsAvailable" class="h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                  <div 
                    ...
                    <div v-if="session.speakers?.length" class="space-y-3">
                      ...
                      >
                        ...
                        <div class="flex-1 min-w-0">
                          <p class="font-medium text-gray-900 dark:text-gray-100 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors">
                            {{ speaker.name }}
                          </p>
                        ...
                        <svg class="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-gray-400 dark:group-hover:text-gray-500 transition-colors flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            ...
            <aside class="hidden lg:block">
              <div class="sticky top-24 space-y-5">
                ...
                >
                  <!-- Status -->
                  <div class="mb-5">
                    <div v-if="hasRsvp && rsvpStatus === 'confirmed'" class="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
                      <svg class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                      </svg>
                      <span class="font-semibold">You're going!</span>
                    </div>
                    <div v-else-if="hasRsvp && rsvpStatus === 'waitlist'" class="flex items-center gap-2 text-amber-600 dark:text-amber-400">
                      <svg class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <div v-if="meetup.seatsAvailable" class="mb-5">
                    <div class="flex items-baseline justify-between mb-2">
                      ...
                      <span 
                        v-if="spotsRemaining !== null && spotsRemaining <= 10 && spotsRemaining > 0"
                  ...
                  <template v-if="!isAuthenticated && canRsvp">
                    ...
                    <p class="mt-3 text-center text-xs text-gray-500 dark:text-gray-400">
                      ...
                      <Link href="/register" class="underline hover:text-gray-900 dark:hover:text-gray-100">Register</Link>
                    </p>
                  </template>
                  ...
                  <template v-else-if="!canRsvp">
                    <div class="py-3 px-4 text-center text-sm text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-xl">
                      RSVPs are closed
                    </div>
                  </template>

                  <!-- Messages -->
                  <div v-if="rsvpSuccess" class="mt-4 p-3 text-sm text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg">
                    {{ rsvpSuccess }}
                  </div>
                  <div v-if="rsvpError" class="mt-4 p-3 text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    {{ rsvpError }}
                  </div>
                ...
                <!-- Sponsors Card -->
                <div 
                  v-if="meetup.sponsors && meetup.sponsors.length"
                ...
                >
                  ...
                  <div class="space-y-2">
                    ...
                    >
                      <span class="font-medium text-gray-900 dark:text-gray-100">{{ sponsor.name }}</span>
                      <svg class="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-gray-400 dark:group-hover:text-gray-500 transition-colors" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M3 10a.75.75 0 01.75-.75h10.638L10.23 5.29a.75.75 0 111.04-1.08l5.5 5.25a.75.75 0 010 1.08l-5.5 5.25a.75.75 0 11-1.04-1.08l4.158-3.96H3.75A.75.75 0 013 10z" clip-rule="evenodd" />
                      </svg>
                    </a>
                  </div>
                ...
                <!-- Attendees Preview -->
                <div v-if="isAuthenticated && attendees.length > 0" class="p-5 bg-white dark:bg-gray-800/80 rounded-2xl border border-gray-200 dark:border-gray-700">
        ...
        <template v-else>
          <div class="text-center py-20">
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-6">The meetup you're looking for doesn't exist or has been removed.</p>
            <Link 
              href="/meetups"
