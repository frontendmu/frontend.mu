              ...
              <div class="sticky top-24 space-y-8">
                ...
                <div class="bg-white dark:bg-verse-900/40 border border-gray-100 dark:border-verse-800 rounded-xl overflow-hidden shadow-sm">
                  ...
                  <div class="p-5 space-y-4">
                    <a v-if="speaker.github_account" :href="`https://github.com/${speaker.github_account}`" target="_blank" class="flex items-center justify-between p-3 bg-white dark:bg-verse-900/40 border border-gray-100 dark:border-verse-800 rounded-lg hover:border-verse-500 transition-all group">
                      ...
                      <span class="text-[10px] font-mono text-gray-400">@{{ speaker.github_account }}</span>
                    </a>
