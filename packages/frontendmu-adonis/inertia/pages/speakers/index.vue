            ...
            >
              ...
              <Link :href="`/speaker/${speaker.id}`" class="absolute inset-0 z-20 rounded-[2rem]" />
                ...
                <div class="absolute bottom-6 left-6 right-6 z-30 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
                  <a v-if="speaker.githubUsername" :href="`https://github.com/${speaker.githubUsername}`" target="_blank" class="p-3 bg-white/90 dark:bg-verse-950/90 backdrop-blur-md rounded-xl text-verse-500 dark:text-verse-300 hover:bg-verse-500 hover:text-white transition-colors shadow-lg">
              ...
              <div class="mt-4 space-y-1">
                ...
                <p v-if="speaker.githubUsername" class="text-xs font-bold text-gray-400 dark:text-gray-500">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-8 gap-y-20">
            ...
            >
              ...
              <div class="text-center md:text-left">
                ...
                <p v-if="speaker.githubUsername" class="text-xs font-black uppercase tracking-widest text-gray-400">
                  @{{ speaker.githubUsername }}
                </p>
              </div>
            </Link>
