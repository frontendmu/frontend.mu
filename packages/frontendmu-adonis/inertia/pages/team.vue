          ...
          <div class="space-y-3">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p
                    class="text-xs font-bold text-gray-900 dark:text-gray-100 group-hover:text-verse-500 transition-colors"
                  >
              ...
              <svg
                class="w-3.5 h-3.5 text-gray-300 dark:text-gray-600 group-hover:text-verse-500 transition-colors"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
