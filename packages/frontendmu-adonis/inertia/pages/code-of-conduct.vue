  ...
  <main class="relative min-h-screen pt-40 pb-24">
      <div class="contain relative z-10">
        ...
        <div class="max-w-4xl mb-24 space-y-6">
          <p class="text-sm font-medium text-gray-400 dark:text-gray-500">Community standards</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div class="lg:col-span-8 space-y-24">
            ...
            <section class="space-y-8">
              <div class="flex items-center gap-3">
                ...
                <h2 class="text-sm font-semibold uppercase tracking-wider text-verse-500">Our Pledge</h2>
              </div>
            ...
            <section class="space-y-8">
              <div class="flex items-center gap-3">
                <span class="h-px w-8 bg-verse-500"></span>
                <h2 class="text-sm font-semibold uppercase tracking-wider text-verse-500">Our Standards</h2>
              </div>
            ...
            <section class="space-y-8">
              <div class="flex items-center gap-3">
                <span class="h-px w-8 bg-verse-500"></span>
                <h2 class="text-sm font-semibold uppercase tracking-wider text-verse-500">Enforcement</h2>
              </div>
          ...
          <div class="lg:col-span-4 space-y-8 sticky top-32">
            <div class="p-8 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-2xl shadow-2xl space-y-6">
              ...
              <a href="mailto:hello@frontend.mu" class="block w-full py-4 bg-verse-500 text-white text-center font-bold text-sm rounded-lg hover:scale-105 active:scale-95 transition-all">
                Email Leadership
              </a>
            </div>
            ...
            <div class="p-8 border border-verse-100 dark:border-verse-800 rounded-2xl space-y-4 bg-white/50 dark:bg-verse-950/20 backdrop-blur-xl">
              <h4 class="text-sm font-semibold uppercase tracking-wider text-gray-400">Attribution</h4>
