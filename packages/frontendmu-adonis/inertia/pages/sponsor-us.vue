  ...
  <main class="relative min-h-screen pt-20 pb-32">
      <div class="contain relative z-10 max-w-5xl">
        ...
        <div class="mb-20 space-y-4">
          <p class="text-sm font-medium text-gray-400 dark:text-gray-500">Partnership</p>

          <h1 class="text-5xl md:text-6xl font-display tracking-tight dark:text-white leading-none">
            Sponsor <span class="font-display-italic text-verse-600 dark:text-verse-400">us</span>
          </h1>
            ...
            <div class="p-8 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-2xl shadow-2xl space-y-6">
              ...
              <div class="pt-2">
                <a
                  ...
                  class="block w-full py-4 bg-verse-500 text-white text-center font-bold text-sm rounded-lg hover:scale-105 active:scale-95 transition-all shadow-lg shadow-black/20"
                >
                  Send an Inquiry
                </a>
              </div>
